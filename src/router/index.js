...
const router = createRouter({
  // history: createWebHistory(import.meta.env.BASE_URL), // <- This is for local production
  history: createWebHashHistory(import.meta.env.BASE_URL), // <- This is for git pages
  routes: [
    // {
    //   path: '/',
    //   name: '',
